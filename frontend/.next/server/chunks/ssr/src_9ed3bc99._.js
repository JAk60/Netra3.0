...
function SQLAgentChat() {
        ...
        try {
            ...
            if (response.ok) {
                if (data.message && data.message.startsWith("CLARIFY:")) {
                    ...
                    addMessage(`${data.message}`, false, 'error');
                } else {
                    if (data.generated_sql) {
                        addMessage("", false, 'sql', data.generated_sql);
                    }
    ...
    const handleDrishtiRequest = async (variables)=>{
        try {
            ...
            if (response.ok) {
                if (data.error) {
                    addMessage(`API Error: ${data.message}`, false, 'error');
                } else {
                    // Display component information
                    const componentInfo = `Component: ${data.component_name}\nID: ${data.component_id}\nNomenclature: ${data.nomenclature || 'N/A'}`;
                    ...
                    addMessage("✅ Visualization data fetched successfully! In a full implementation, this would show an interactive network diagram.", false, 'success');
                }
            } else {
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            addMessage(`Unexpected error: ${error.message}`, false, 'error');
        }
        setIsLoading(false);
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Ask questions, run queries, or create visualizations"
                        }, void 0, false, {
                            fileName: "[project]/src/components/Drishti/chat-input.tsx",
                            lineNumber: 456,
                            columnNumber: 11
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$registry$2f$new$2d$york$2d$v4$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ScrollArea"], {
...
//# sourceMappingURL=src_9ed3bc99._.js.map