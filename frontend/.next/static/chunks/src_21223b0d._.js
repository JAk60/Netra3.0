...
function SQLAgentChat() {
    ...
    const handleApiRequest = async (query)=>{
        try {
            ...
            if (response.ok) {
                if (data.error) {
                    addMessage("Error: ".concat(data.message), false, 'error');
                } else {
            ...
            addMessage("Connection error: ".concat(error.message), false, 'error');
        }
    };
        ...
        try {
            ...
            if (response.ok) {
                if (data.message && data.message.startsWith("CLARIFY:")) {
                    ...
                    addMessage("".concat(data.message), false, 'error');
                } else {
                    if (data.generated_sql) {
                        addMessage("", false, 'sql', data.generated_sql);
                    }
    ...
    const handleDrishtiRequest = async (variables)=>{
        try {
            ...
            if (response.ok) {
                if (data.error) {
                    addMessage("API Error: ".concat(data.message), false, 'error');
                } else {
                    // Display component information
                    const componentInfo = "Component: ".concat(data.component_name, "\nID: ").concat(data.component_id, "\nNomenclature: ").concat(data.nomenclature || 'N/A');
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            addMessage("Unexpected error: ".concat(error.message), false, 'error');
        }
        setIsLoading(false);
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$registry$2f$new$2d$york$2d$v4$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollArea"], {
...
_s(SQLAgentChat, "Hv25kFn4cEDfSomF3D91lPk/T1I=");
_c4 = SQLAgentChat;
var _c, _c1, _c2, _c3, _c4;
__turbopack_context__.k.register(_c, "MessageBubble");
__turbopack_context__.k.register(_c1, "ResultsTable");
__turbopack_context__.k.register(_c2, "SQLDisplay");
__turbopack_context__.k.register(_c3, "ReliabilityStats");
__turbopack_context__.k.register(_c4, "SQLAgentChat");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_21223b0d._.js.map