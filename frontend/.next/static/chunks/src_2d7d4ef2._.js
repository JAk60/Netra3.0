...
// Function to combine all ships into single canvas
const combineShipsData = function(ships) {
    let horizontalSpacing = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 400;
    let allNodes = [];
    let allEdges = [];
    let currentXOffset = 0;
    ships.forEach((ship, shipIndex)=>{
        const shipNodes = ship.reactflow.nodes || [];
        const shipEdges = ship.reactflow.edges || [];
        // Offset nodes horizontally for each ship
        const offsetNodes = shipNodes.map((node)=>({
                ...node,
                position: {
        ...
        // Calculate next offset based on ship width
        const maxX = Math.max(...shipNodes.map((node)=>{
            var _node_style;
            return node.position.x + (((_node_style = node.style) === null || _node_style === void 0 ? void 0 : _node_style.width) || 200);
        }));
        currentXOffset = maxX + horizontalSpacing;
    });
    return {
        nodes: allNodes,
        edges: allEdges
...
// Single Canvas Component for Multiple Ships
const MultiShipCanvas = (param)=>{
    let { data = mockData } = param;
    _s();
    const ships = (data === null || data === void 0 ? void 0 : data.ships) || [];
    // Combine all ships data
    const combinedData = combineShipsData(ships);
    const [nodes, setNodes, onNodesChange] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$react$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useNodesState"])(combinedData.nodes);
    const [edges, setEdges, onEdgesChange] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$react$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useEdgesState"])(combinedData.edges);
    ...
    const onConnect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MultiShipCanvas.useCallback[onConnect]": (params)=>setEdges({
                "MultiShipCanvas.useCallback[onConnect]": (eds)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$system$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addEdge"])(params, eds)
            }["MultiShipCanvas.useCallback[onConnect]"])
    }["MultiShipCanvas.useCallback[onConnect]"], [
        setEdges
    ]);
    const onLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MultiShipCanvas.useCallback[onLayout]": (direction)=>{
            ...
            window.requestAnimationFrame({
                "MultiShipCanvas.useCallback[onLayout]": ()=>{
                    fitView();
                }
            }["MultiShipCanvas.useCallback[onLayout]"]);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "h-screen w-full bg-black/80",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "p-4 bg-gray-900 text-white border-b",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: ships.map((ship, index)=>{
                            var _ship_reactflow_metadata;
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "px-2 py-1 bg-blue-600 rounded text-xs",
                                children: ((_ship_reactflow_metadata = ship.reactflow.metadata) === null || _ship_reactflow_metadata === void 0 ? void 0 : _ship_reactflow_metadata.ship_name) || "Ship ".concat(index + 1)
                            }, index, false, {
                                fileName: "[project]/src/components/Drishti/right-sidebar.tsx",
                                lineNumber: 3735,
                                columnNumber: 13
...
_s(MultiShipCanvas, "jcslaI9VOOiMvj6ltBbBsHN01JQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$react$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useNodesState"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$react$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useEdgesState"],
...
const ShipDiagramsApp = ()=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "w-full h-screen bg-gray-50",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MultiShipCanvas, {}, void 0, false, {
            fileName: "[project]/src/components/Drishti/right-sidebar.tsx",
            lineNumber: 3767,
            columnNumber: 7
        }, ("TURBOPACK compile-time value", void 0))
...
_c1 = ShipDiagramsApp;
const __TURBOPACK__default__export__ = ShipDiagramsApp;
var _c, _c1;
__turbopack_context__.k.register(_c, "MultiShipCanvas");
__turbopack_context__.k.register(_c1, "ShipDiagramsApp");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_2d7d4ef2._.js.map