...
const ExpandableNode = (param)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            data.isShipRoot && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
const getLayoutedElements = function(nodes, edges) {
    ...
    const shipNodes = nodes.filter((node)=>{
        var _node_data;
        return (_node_data = node.data) === null || _node_data === void 0 ? void 0 : _node_data.isShipRoot;
    });
    const detailNodes = nodes.filter((node)=>{
        var _node_data;
        return !((_node_data = node.data) === null || _node_data === void 0 ? void 0 : _node_data.isShipRoot);
    });
    ...
    const layoutedDetailNodes = detailNodes.map((node)=>{
        var _node_data;
        const shipIndex = ((_node_data = node.data) === null || _node_data === void 0 ? void 0 : _node_data.shipIndex) || 0;
        const baseX = shipIndex * shipSpacing;
        // Get all detail nodes for this ship
        const shipDetailNodes = detailNodes.filter((n)=>{
            var _n_data;
            return ((_n_data = n.data) === null || _n_data === void 0 ? void 0 : _n_data.shipIndex) === shipIndex;
        });
...
// Main component
const FleetDiagramsApp = (param)=>{
    let { data = mockData } = param;
    _s();
    ...
    const [expandedShips, setExpandedShips] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set());
    ...
    const ships = (data === null || data === void 0 ? void 0 : data.ships) || [];
    const onConnect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FleetDiagramsApp.useCallback[onConnect]": (params)=>setEdges({
                "FleetDiagramsApp.useCallback[onConnect]": (eds)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$system$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addEdge"])(params, eds)
            }["FleetDiagramsApp.useCallback[onConnect]"])
    }["FleetDiagramsApp.useCallback[onConnect]"], [
        setEdges
    ]);
    // Handle ship expansion/collapse
    const handleShipExpand = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FleetDiagramsApp.useCallback[handleShipExpand]": (shipIndex, isExpanding)=>{
    ...
    }["FleetDiagramsApp.useCallback[handleShipExpand]"], [
        expandedShips
    ]);
    // Prepare nodes and edges for expandable view
    const prepareFleetData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FleetDiagramsApp.useCallback[prepareFleetData]": ()=>{
            if (!ships || ships.length === 0) return {
                nodes: [],
                edges: []
            };
            // Create ship root nodes
            const shipRootNodes = ships.map({
                "FleetDiagramsApp.useCallback[prepareFleetData].shipRootNodes": (ship, index)=>{
                    var _shipData_metadata;
                    const shipData = (ship === null || ship === void 0 ? void 0 : ship.reactflow) || {};
                    const shipNodes = shipData.nodes || [];
                    const isExpanded = expandedShips.has(index);
                    return {
                        id: "ship-root-".concat(index),
                        type: 'expandable',
                        position: {
                            x: index * 400,
                            y: 0
                        ...
                        data: {
                            label: ((_shipData_metadata = shipData.metadata) === null || _shipData_metadata === void 0 ? void 0 : _shipData_metadata.ship_name) || "Ship ".concat(index + 1),
                            isShipRoot: true,
                            isExpanded: isExpanded,
                            nodeCount: shipNodes.length,
                            onExpand: handleShipExpand,
                            shipIndex: index,
                            description: "".concat(shipNodes.length, " components")
                        }
                    };
                }
            }["FleetDiagramsApp.useCallback[prepareFleetData].shipRootNodes"]);
            // Add expanded ship details
            let allNodes = [
                ...shipRootNodes
            ];
            let allEdges = [];
            expandedShips.forEach({
                "FleetDiagramsApp.useCallback[prepareFleetData]": (shipIndex)=>{
                    const ship = ships[shipIndex];
                    if (ship === null || ship === void 0 ? void 0 : ship.reactflow) {
                        const shipData = ship.reactflow;
                        const shipNodes = shipData.nodes || [];
                        const shipEdges = shipData.edges || [];
                        // Add ship detail nodes with original IDs
                        const expandedNodes = shipNodes.map({
                            "FleetDiagramsApp.useCallback[prepareFleetData].expandedNodes": (node)=>{
                                var _node_data, _shipData_metadata;
                                return {
                                    ...node,
                                    id: "expanded-".concat(shipIndex, "-").concat(node.id),
                                    type: 'expandable',
                                    data: {
                                        ...node.data,
                                        isShipRoot: false,
                                        shipIndex: shipIndex,
                                        nodeType: getNodeType(((_node_data = node.data) === null || _node_data === void 0 ? void 0 : _node_data.label) || ''),
                                        description: "Ship: ".concat(((_shipData_metadata = shipData.metadata) === null || _shipData_metadata === void 0 ? void 0 : _shipData_metadata.ship_name) || "Ship ".concat(shipIndex + 1))
                                    }
                                };
                            }
                        }["FleetDiagramsApp.useCallback[prepareFleetData].expandedNodes"]);
                        // Add ship internal edges
                        const internalEdges = shipEdges.map({
                            "FleetDiagramsApp.useCallback[prepareFleetData].internalEdges": (edge)=>({
                                    ...edge,
                                    id: "expanded-".concat(shipIndex, "-").concat(edge.id),
                                    source: "expanded-".concat(shipIndex, "-").concat(edge.source),
                                    target: "expanded-".concat(shipIndex, "-").concat(edge.target),
                                    style: {
                                        stroke: '#64748b',
                                        strokeWidth: 2,
                                        strokeDasharray: '5,5'
                        ...
                        }["FleetDiagramsApp.useCallback[prepareFleetData].internalEdges"]);
                        // Add connection from ship root to detail nodes
                        const connectionEdges = shipNodes.map({
                            "FleetDiagramsApp.useCallback[prepareFleetData].connectionEdges": (node)=>({
                                    id: "connection-".concat(shipIndex, "-").concat(node.id),
                                    source: "ship-root-".concat(shipIndex),
                                    target: "expanded-".concat(shipIndex, "-").concat(node.id),
                                    type: 'smoothstep',
                                    style: {
                                        stroke: '#3b82f6',
                                        strokeWidth: 3,
                        ...
                        }["FleetDiagramsApp.useCallback[prepareFleetData].connectionEdges"]);
                        allNodes = [
                            ...allNodes,
                            ...expandedNodes
                        ];
    ...
    const onLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FleetDiagramsApp.useCallback[onLayout]": (direction)=>{
            ...
            setTimeout({
                "FleetDiagramsApp.useCallback[onLayout]": ()=>{
                    fitView({
                        padding: 0.2
                    });
                }
            }["FleetDiagramsApp.useCallback[onLayout]"], 100);
        }
    }["FleetDiagramsApp.useCallback[onLayout]"], [
        prepareFleetData,
        setNodes,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FleetDiagramsApp.useEffect": ()=>{
            if (ships.length > 0) {
                ...
                }["FleetDiagramsApp.useEffect"], 100);
            }
        }
    }["FleetDiagramsApp.useEffect"], [
        ships,
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: ships.map((ship, index)=>{
                                    var _ship_reactflow_metadata, _ship_reactflow;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "px-3 py-1 rounded-full text-xs font-medium transition-colors ".concat(expandedShips.has(index) ? 'bg-green-500 text-white' : 'bg-gray-600 text-gray-300'),
                                        children: [
                                            (ship === null || ship === void 0 ? void 0 : (_ship_reactflow = ship.reactflow) === null || _ship_reactflow === void 0 ? void 0 : (_ship_reactflow_metadata = _ship_reactflow.metadata) === null || _ship_reactflow_metadata === void 0 ? void 0 : _ship_reactflow_metadata.ship_name) || "Ship ".concat(index + 1),
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$react$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactFlow"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$react$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["MiniMap"], {
                            ...
                            nodeColor: (node)=>{
                                var _node_data, _node_data1, _node_data2;
                                if ((_node_data = node.data) === null || _node_data === void 0 ? void 0 : _node_data.isShipRoot) return '#2563eb';
                                if (((_node_data1 = node.data) === null || _node_data1 === void 0 ? void 0 : _node_data1.nodeType) === 'system') return '#059669';
                                if (((_node_data2 = node.data) === null || _node_data2 === void 0 ? void 0 : _node_data2.nodeType) === 'equipment') return '#7c3aed';
                                return '#6b7280';
                            },
                            nodeStrokeWidth: 2,
                            zoomable: true,
...
_s(FleetDiagramsApp, "F0UQIUkT5zN7QG0fwfT2B9aNqAY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$react$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useNodesState"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xyflow$2f$react$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useEdgesState"],
...
_c1 = FleetDiagramsApp;
const __TURBOPACK__default__export__ = FleetDiagramsApp;
var _c, _c1;
__turbopack_context__.k.register(_c, "ExpandableNode");
__turbopack_context__.k.register(_c1, "FleetDiagramsApp");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_7cbb8e2d._.js.map