...
function ChatMain(param) {
    ...
    const sendMessage = async ()=>{
        ...
        try {
            ...
            const errorMessage = {
                role: "assistant",
                content: "Sorry, I encountered an error: ".concat(error.message, ". Please try again."),
                timestamp: new Date().toISOString(),
                isError: true
            };
            setChatState((prev)=>({
...
_s1(ChatMain, "k64K/y/dg6qGrGeuYmYN82K/9/M=", false, function() {
    return [
        useDebounce
    ];
});
...
//# sourceMappingURL=src_d8cdd66c._.js.map