...
"[project]/src/store/EntityStore.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const useEntityStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set)=>({
        ships: {},
        ...
        addSystemConfiguration: (systemConfiguration)=>set((state)=>({
                    systemConfigurations: {
                        ...state.systemConfigurations,
                        [systemConfiguration.id]: systemConfiguration
                    }
                })),
        removeSystemConfiguration: (id)=>set((state)=>{
                const { [id]: _, ...rest } = state.systemConfigurations;
                return {
                    systemConfigurations: rest
                };
            }),
        updateSystemConfiguration: (systemConfiguration)=>set((state)=>({
                    systemConfigurations: {
                        ...state.systemConfigurations,
                        [systemConfiguration.id]: systemConfiguration
                    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$EntityStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store/EntityStore.ts [app-client] (ecmascript)");
;
...
function ChatMain(param) {
    let { ships } = param;
    _s();
    const { setShip } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$EntityStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEntityStore"])();
...
_s(ChatMain, "CRrl+Tumy1BWRskgcvpHEd1bKmk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$EntityStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEntityStore"]
    ];
});
_c = ChatMain;
var _c;
...
//# sourceMappingURL=src_df367ad4._.js.map