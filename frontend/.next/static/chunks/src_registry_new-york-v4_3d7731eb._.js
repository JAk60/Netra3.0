...
"[project]/src/registry/new-york-v4/charts/chart-bar-interactive.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ChartBarInteractive() {
    ...
    const total = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ChartBarInteractive.useMemo[total]": ()=>({
                desktop: chartData.reduce({
                    "ChartBarInteractive.useMemo[total]": (acc, curr)=>acc + curr.desktop
                }["ChartBarInteractive.useMemo[total]"], 0),
                mobile: chartData.reduce({
                    "ChartBarInteractive.useMemo[total]": (acc, curr)=>acc + curr.mobile
                }["ChartBarInteractive.useMemo[total]"], 0)
            })
    }["ChartBarInteractive.useMemo[total]"], []);
...
_s(ChartBarInteractive, "2DfD/VguUGtPwotVXme5FiMLoTE=");
_c = ChartBarInteractive;
var _c;
__turbopack_context__.k.register(_c, "ChartBarInteractive");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_registry_new-york-v4_3d7731eb._.js.map