...
import { ExpertJudgementData, expertJudgementSchema } from '@/lib/schemas/etabetaform';


export const ExpertJudgementForm: React.FC = () => {
    const { updateFormData } = useEtaBetaStore();
    const [isSubmitting, setIsSubmitting] = useState(false);
    const [success, setSuccess] = useState(false);

    const { register, handleSubmit, formState: { errors }, reset } = useForm<ExpertJudgementData>({
