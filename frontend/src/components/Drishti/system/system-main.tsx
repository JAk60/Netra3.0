...
import ShipEntryForm from './forms/ship/create_new_ship_form';
    ...
    return (
        <div className="w-full bg-muted/30 min-h-screen p-6 overflow-x-hidden">
            <div className="max-w-7xl mx-auto space-y-6 w-full">
                <Header showShipForm={showShipForm} setShowShipForm={setShowShipForm} />
                {showShipForm ? <ShipEntryForm setShowShipForm={setShowShipForm} /> :
                    (<>
...
function getEquipmentForShip(selectedShip: string) {
