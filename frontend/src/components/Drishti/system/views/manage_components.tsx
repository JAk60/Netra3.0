...
import MonthlyUtilization from '../forms/monthly_utilization/monthly_utilization';
import { Parameters } from '../forms/reliability/Params_Main';
import AddComponentForm from '../forms/ship/add_equipment';
import { OverhaulMain } from '../forms/maintenance/Overhaulmain';
    ...
    return (
        <Tabs defaultValue="add" className="space-y-4">
            <TabsList>
                ...
                <TabsTrigger value="monthly_utilization">
                    <Upload className="w-4 h-4 mr-2" />
                    Monthly Utilization
                </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="monthly_utilization">
                <MonthlyUtilization />
            </TabsContent>
        </Tabs>
    );
